  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative rounded-2xl border border-accent-500/30 dark:border-accent-500/30 bg-gradient-to-br from-white via-amber-500/5 to-white dark:from-surface-dark-card dark:via-surface-dark-elevated dark:to-surface-dark-card p-6 sm:p-8 lg:p-10 shadow-xl dark:shadow-amber-soft/10 overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent-500/15 text-accent-700 dark:text-accent-400 border border-accent-500/30 text-xs font-semibold font-mono">
                  <Sparkles className="w-3.5 h-3.5" />
                  Engineering Manager Endorsement
                </span>
                {lor.cin && (
                  <span className="text-[11px] font-mono text-slate-500 dark:text-slate-400 px-2.5 py-1 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
                    Ref: {lor.cin}
                  </span>
                )}
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-surface-light-border dark:border-surface-dark-border/80 flex items-start gap-3.5">
                <div className="p-2.5 rounded-lg bg-accent-500/10 text-accent-500 border border-accent-500/20 shrink-0">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                    Candidate: <span className="font-semibold text-slate-700 dark:text-slate-300">{lor.candidateName}</span> ({lor.candidateInstitution})
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-accent-500/10 dark:bg-accent-500/10 border-l-3 border-accent-500 text-xs sm:text-sm">
                <div className="flex items-center gap-1.5 font-bold text-accent-700 dark:text-accent-400 mb-1 tracking-wide uppercase text-[10px] font-mono">
            ...
            <div className="lg:col-span-5 flex flex-col items-center">
              <div
                className="group/doc relative w-full max-w-sm rounded-xl overflow-hidden border-2 border-slate-200 dark:border-surface-dark-border bg-white dark:bg-slate-950 shadow-2xl transition-all duration-300 hover:border-accent-500/60 hover:shadow-amber-soft/30 cursor-pointer"
                onClick={() => setShowModal(true)}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
              ...
              >
                ...
                <div className="p-3.5 bg-slate-50 dark:bg-surface-dark-elevated/90 border-t border-slate-200 dark:border-surface-dark-border flex items-center justify-between text-xs">
